...
### One goal. A team of AI agents that plan, build, review each other's work, and run across every machine you own.
...
assistant. Need more horsepower? Fleet reaches across every machine on your
network over SSH -- no dashboards, no orchestration YAML, just conversation.
