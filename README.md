...
| Sprint-start Member Prep (auth, stray-process sweep, git/beads pull, per-member reporting) | [docs/member-prep-and-stray-sweep.md](docs/member-prep-and-stray-sweep.md) |
