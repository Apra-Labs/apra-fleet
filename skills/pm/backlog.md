...
- **G10** — Proactive permission provisioning. Stack profiles in `profiles/`, composition guide in `permissions.md`, project ledger in `permissions.json`.
- **G11** — Installer pre-approves fleet tools, Agent(*), skill reads.
