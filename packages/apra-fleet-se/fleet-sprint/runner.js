...
// where the boundary is drawn and why the brackets themselves stayed here.
// resolveGitProviderForClassification was module-private before the move and
// is imported (not re-exported) purely for this file's own call sites.
import {
    checkMemberTopology, classifyGitFailure, runGitStep,
    resolveGitProviderForClassification, commandResultToSoftGit,
