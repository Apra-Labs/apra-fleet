...
> [Install for other providers](install.md#install-for-other-providers-antigravity-codex-copilot-gemini).
...
onboarding. See [docs/features/member-tags.md](features/member-tags.md).
...
to date. See [keeping Fleet updated](features/update.md).
...
To write your own skill, see [docs/writing-skills.md](writing-skills.md).
...
[docs/opencode-exploration.md](opencode-exploration.md) for details.
...
[docs/provider-guide.md](provider-guide.md).
...
automatically. See [docs/features/auto-sprint-install.md](features/auto-sprint-install.md).

Want to build your own skill on top of Fleet? See [docs/writing-skills.md](writing-skills.md).
...
| Choosing a provider | [docs/provider-guide.md](provider-guide.md) |
| FAQ | [docs/FAQ.md](FAQ.md) |
| Troubleshooting | [docs/troubleshooting.md](troubleshooting.md) |
| Keeping Fleet updated (`apra-fleet update`) | [docs/features/update.md](features/update.md) |
| Secure credentials and passwords | [docs/features/oob-auth.md](features/oob-auth.md) |
