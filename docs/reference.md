...
[Quick Start](#quick-start-5-minutes) - [Live Demo](#watch-a-fleet-work) - [How It Works](#how-it-works) - [fleet-sprint Getting Started Guide](fleet-sprint-getting-started.md) - [Website](https://apra-labs.github.io/apra-fleet)
...
> ([Markdown](fleet-sprint-getting-started.md) if you're reading this on
> GitHub -- [PDF](fleet-sprint-getting-started.pdf)) -- a plain-English walkthrough
...
**Component Docs:** [fleet-sprint](../packages/apra-fleet-se/fleet-sprint/docs/README.md) | [auto-sprint.js](../packages/apra-fleet-se/apra-pm/docs/sprint-workflow.md) | [apra-fleet-client](../packages/apra-fleet-client/docs/overview.md) | [apra-pm](../packages/apra-fleet-se/apra-pm/README.md) | [apra-fleet-mcp](mcp-tools.md) | [Agent Roles](../packages/apra-fleet-se/docs/role-contracts.md)
...
[Client-side provider selection](knowledge-layer-design.md#client-side-provider-selection)
...
[Per-repo KB isolation](knowledge-layer.md#per-repo-kb-isolation) for
...
See [docs/knowledge-layer.md](knowledge-layer.md) for the full guide.
...
any LLM or log; see [docs/secret-variables.md](secret-variables.md).
...
| Topic | Link |
|-------|------|
| **fleet-sprint Getting Started Guide (start here, plain English)** | [Website](https://apra-labs.github.io/apra-fleet/fleet-sprint-getting-started.html) - [Markdown](fleet-sprint-getting-started.md) - [PDF](fleet-sprint-getting-started.pdf) |
| Codebase wiki (architecture, internals, AI Q&A) | [DeepWiki](https://deepwiki.com/Apra-Labs/apra-fleet) |
| Install, uninstall, the `--llm` flag | [docs/install.md](install.md) |
| Choosing a provider (roles, gotchas, mixing providers, OpenCode/local models) | [docs/provider-guide.md](provider-guide.md) |
| Transport, service mode, and supported interfaces | [docs/transport-and-service-mode.md](transport-and-service-mode.md) |
| Cost model (tiering, shell-over-prompts, measured token spend) | [docs/cost-model.md](cost-model.md) |
| The PM skill (doer-reviewer sprints, `/pm` commands) | [docs/pm-skill-overview.md](pm-skill-overview.md) |
| FAQ | [docs/FAQ.md](FAQ.md) |
| Troubleshooting | [docs/troubleshooting.md](troubleshooting.md) |
| Keeping Fleet updated (`apra-fleet update`) | [docs/features/update.md](features/update.md) |
| Live member activity (`apra-fleet watch`, `logging.previewChars`) | [docs/features/watch.md](features/watch.md) |
| Secret variables and passwords | [docs/secret-variables.md](secret-variables.md) - [docs/features/oob-auth.md](features/oob-auth.md) |
| Member category and tags | [docs/features/member-tags.md](features/member-tags.md) |
| Enabling SSH on a remote machine (if it does not have it yet) | [docs/ssh-setup.md](ssh-setup.md) |
| Git authentication | [docs/design-git-auth.md](design-git-auth.md) |
| Cloud compute | [docs/cloud-compute.md](cloud-compute.md) |
| Architecture | [docs/architecture.md](architecture.md) |
| Dispatch and orchestration reliability design (Windows completion-on-exit, stall detector, test-runner wall-clock bound) | [docs/dispatch-reliability-hardening.md](dispatch-reliability-hardening.md) - [docs/stall-detector-resilience.md](stall-detector-resilience.md) |
| Windows shell selection (probe order, gitbash/pwsh7/powershell5, shell vs os) | [docs/windows-shell-selection.md](windows-shell-selection.md) |
| Cross-shell command construction for member-bound commands | [docs/cross-shell-command-construction.md](cross-shell-command-construction.md) |
| Knowledge Layer (setup, usage, provider swap) | [docs/knowledge-layer.md](knowledge-layer.md) |
| Code intelligence provider abstraction | [docs/code-intelligence-providers.md](code-intelligence-providers.md) |
| Hub-spoke cloud migration plan (historical; see tier-3 ownership ADR) | [docs/hub-spoke-master-plan.md](hub-spoke-master-plan.md) |
| Tier-3 ownership decision (fleet-dashboard vs `src/hub-service/`) | [docs/adr-tier3-ownership.md](adr-tier3-ownership.md) |
...
| Cooperative workflow pause/resume (engine, viewer, supervisor, fleet-sprint) | [docs/features/workflow-pause-resume.md](features/workflow-pause-resume.md) |
| Supervisor dashboard live-refresh (`/state` + `/events` SSE, tab-activation refresh, in-memory scope expansion) | [docs/features/supervisor-dashboard-live-refresh.md](features/supervisor-dashboard-live-refresh.md) |
...
| Authoring a SEA-embedded `apra-fleet workflow` (manifest, entry contract, launcher env vars) | [docs/authoring-workflows.md](authoring-workflows.md) |
| Workflow launcher fleet-server resolution order (HTTP singleton vs. stdio) | [docs/adr-workflow-server-resolution.md](adr-workflow-server-resolution.md) |
...
| Memory contract v1 inventory findings and invariants (`kb_*`/`code_*` tool surface) | [docs/memory-contract-v1-inventory-notes.md](memory-contract-v1-inventory-notes.md) |
| Memory contract v1 schema generation design (zod -> JSON Schema 2020-12) | [docs/memory-contract-v1-generator-design.md](memory-contract-v1-generator-design.md) |
| Memory contract v1 round-trip validation, drift guard, and T1/T2/T3/T7 handoff design | [docs/memory-contract-v1-roundtrip-and-handoff.md](memory-contract-v1-roundtrip-and-handoff.md) |
