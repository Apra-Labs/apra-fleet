...
<!-- SYNC-SOURCE-ONLY:START -->
> This file is the source of truth for AGENTS.md and AGY.md, generated by `node scripts/sync-agent-docs.mjs` (each gets its own title plus a small tool-specific appendix from `scripts/agent-doc-partials/`). Edit this file, then rerun the script -- do not hand-edit the shared sections of AGENTS.md/AGY.md directly. Text between SYNC-SOURCE-ONLY markers is stripped from the generated copies.
<!-- SYNC-SOURCE-ONLY:END -->
